    ...
    <>
      <main className="relative isolate h-screen">
        ...
        <div className="mx-auto max-w-7xl px-6 py-32 text-center sm:py-40 lg:px-8">
          <p className="text-base font-semibold leading-8 text-zinc-50">404</p>
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-zinc-50 sm:text-5xl">Page not found</h1>
